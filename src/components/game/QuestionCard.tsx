...
export function QuestionCard({
  ...
  const doAnswer = useCallback((index: number) => {
    ...
    // Show potential points (max possible for speed); actual score is server-validated
    if (index >= 0) {
    ...
    setTimeout(() => onAnswer(question.id, index, elapsed), 1500)
